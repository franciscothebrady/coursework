...
a)    A frequency table for `SpendHighways`   
...
The calculation here is using the response position as a value. Calculating the mean or standard deviation for the value in this way would not be meaningful.  
...
c)    Again this depends on the context and the aims of the measurement. Validity of a measurement is dependent on how well it represents the concept it is measuring. A rating from experts on civil liberties and political rights could be a good indicator of how democratic a country is.  
  
  
### Question 8  

a)    For the first method, the measurement levels would be categorical ("favorable", "neutral", "unfavorable"), ordinal, and discrete. For the second method the measurement levels would be quantitative (count of "negative" key words) and discrete.  
