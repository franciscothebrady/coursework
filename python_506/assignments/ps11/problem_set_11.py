...
def convert_gravity_value(value):
    ...
    """
    try:
        if "standard" in value.strip().lower():
...
def create_person(data, planets=None):
    ...
    # convert height and mass to float
    person["height_cm"] = utl.convert_to_float(person.get("height"))
    person["mass_kg"] = utl.convert_to_float(person.get("mass"))

    # convert homeworld and species to dict
    if planets:
        mandalorian_planet = get_mandalorian_data(planets, person.get("homeworld"))
        if mandalorian_planet:
            person["homeworld"] = create_planet(mandalorian_planet)
        # else:
        #     mandalorian_planet = get_swapi_resource(SWAPI_PLANETS, {"search": person.get("homeworld")})["results"][0]
        #     homeworld = create_planet(mandalorian_planet)
    elif person.get("homeworld"):
        try:
            planet = get_swapi_resource(SWAPI_PLANETS, {"search": person.get("homeworld")})[
                "results"
            ][0]
            person["homeworld"] = create_planet(planet)
        except:
            planet = get_swapi_resource(person.get("homeworld"))
            person["homeworld"] = create_planet(planet)
...
def get_mandalorian_data(mandalorian_data, filter):
    ...
    """
    for record in mandalorian_data:
        if record.get("name").lower() == filter.lower():
            return record
    return None
...
def update_planets_visited(data, planet):
    ...
    if "planets_visited" not in data.keys():
        data["planets_visited"] = []
    if planet not in data["planets_visited"]:
...
def main():
    ...
    pp.pprint(f"\n1.2 First 2 records of mandalorian_people = \n{mandalorian_people[0:2]}")

    assert mandalorian_people[0]["name"] == "Din Djarin"
    ...
    pp.pprint(
        "return value of utl.convert_to_none('Yoda ', utl.NONE_VALUES):"
        f" {utl.convert_to_none('Yoda ', utl.NONE_VALUES)}"
    )
    ...
    pp.pprint(f'return value of utl.convert_to_float("4.0"): {utl.convert_to_float("4,000")}')
    ...
    # print assert
    pp.pprint(f'return value of utl.convert_to_int("506 "): {utl.convert_to_int("506 ")}')

    # Problem 2.6
    assert utl.convert_to_list("Diag, Hatcher, North Quad", ", ") == [
        "Diag",
        "Hatcher",
        "North Quad",
    ]
    ...
    # print assert
    pp.pprint(
        'return value of utl.convert_to_list("Han, Leia, Luke", ", "):'
        f' {utl.convert_to_list("Han, Leia, Luke", ", ")}'
    )
    ...
    # print assert
    pp.pprint(
        'return value of convert_gravity_value("1 standard"):'
        f' {convert_gravity_value("1 standard")}'
    )
    ...
    ## check against fxt files
    # nevarro
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-mandalorian_nevarro.json")
    #     fxt = utl.read_json("fxt-mandalorian_nevarro.json")
    #     assert stu == fxt
    # arvala-7
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-mandalorian_arvala_7.json")
    #     fxt = utl.read_json("fxt-mandalorian_arvala_7.json")
    #     assert stu == fxt
    ...
    # compare against fxt file
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-ig_11.json")
    #     fxt = utl.read_json("fxt-ig_11.json")
    #     assert stu == fxt
    ...
    # compare against fxt file
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-mando.json")
    #     fxt = utl.read_json("fxt-mando.json")
    #     assert stu == fxt
    ...
    # compare against fxt file
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-razor_crest.json")
    #     fxt = utl.read_json("fxt-razor_crest.json")
    #     assert stu == fxt

    # Problem 5.5-5.6 Test < create_vehicle >
    # TODO call function
    swapi_sand_crawler = get_swapi_resource(SWAPI_VEHICLES, {"search": "Sand Crawler"})["results"][
        0
    ]
    ...
    # compare against fxt file
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-sand_crawler.json")
    #     fxt = utl.read_json("fxt-sand_crawler.json")
    #     assert stu == fxt
    ...
    # 6.4 Get Greef Karga
    # TODO call function
    swapi_greef_karga = get_mandalorian_data(mandalorian_people, "greef karga")
    greef_karga = create_person(swapi_greef_karga)
    ...
    # compare against fxt file
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-greef_karga.json")
    #     fxt = utl.read_json("fxt-greef_karga.json")
    #     assert stu == fxt

    # 6.6 Update planets_visited with Arvala-7
    # TODO call function
    razor_crest = update_planets_visited(razor_crest, mandalorian_arvala_7)
    ...
    # 7.1 Get Kuiil
    # TODO call function
    swapi_kuiil = get_mandalorian_data(mandalorian_people, "Kuiil")
    kuiil = create_person(swapi_kuiil, mandalorian_planets)
    ...
    # compare against fxt file
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-kuiil.json")
    #     fxt = utl.read_json("fxt-kuiil.json")
    #     assert stu == fxt
    ...
    # compare against fxt file
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-grogu.json")
    #     fxt = utl.read_json("fxt-grogu.json")
    #     assert stu == fxt

    # 7.5-6 Get hovering pram
    # TODO call functions
    swapi_hovering_pram = get_mandalorian_data(mandalorian_vehicles, "Hovering pram")
    hovering_pram = create_vehicle(swapi_hovering_pram)
    ...
    # compare against fxt file
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-grogu_hovering_pram.json")
    #     fxt = utl.read_json("fxt-grogu_hovering_pram.json")
    #     assert stu == fxt
    ...
    # compare against fxt file
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-ig_11_reprogrammed.json")
    #     fxt = utl.read_json("fxt-ig_11_reprogrammed.json")
    #     assert stu == fxt
    ...
    # TODO call function
    swapi_cara_dune = get_mandalorian_data(mandalorian_people, "Carasynthia Dune")
    cara_dune = create_person(swapi_cara_dune)
    ...
    # compare against fxt file
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-cara_dune.json")
    #     fxt = utl.read_json("fxt-cara_dune.json")
    #     assert stu == fxt

    # Problem 8.6 Get Gideon
    # TODO call function
    swapi_moff_gideon = get_mandalorian_data(mandalorian_people, "gideon")
    gideon = create_person(swapi_moff_gideon)

    # Problem 8.7 Get imperial transport
    # TODO call function
    swapi_imperial_transport = get_mandalorian_data(mandalorian_starships, "imperial transport")
    imperial_transport = create_starship(swapi_imperial_transport)
    ...
    # compare against fxt file
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-gideon_imperial_transport.json")
    #     fxt = utl.read_json("fxt-gideon_imperial_transport.json")
    #     assert stu == fxt
    ...
    # TODO call functions
    razor_crest = board_passengers(razor_crest, [mando, grogu])
    razor_crest = update_planets_visited(razor_crest, tatooine)

    # Problem 9.3 Test use of lambda to sort planets
    # TODO call function
    razor_crest["planets_visited"] = sorted(razor_crest["planets_visited"], key=lambda x: x["name"])
    ...
    # compare against fxt file
    # if os.getenv("USER") == "francisco":
    #     stu = utl.read_json("stu-razor_crest_departs.json")
    #     fxt = utl.read_json("fxt-razor_crest_departs.json")
    #     assert stu == fxt
