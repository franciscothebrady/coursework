...
The central limit theorem states that the sampling distribution of the mean income is approximately normal, even if the underlying distribution is skewed because the sample size is larger than 30.  
